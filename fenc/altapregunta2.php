    	...
    	<div class="row">
    		<div id="activa" class="section scrollspy">
    			<form method="post" class="col s12">
                    ...
                    <div class="input-field col s2">
                        Id pregunta<input type="text" name="id_pregunta" placeholder="id_ptrgunta" id="id_pregunta" value="<?php echo $_SESSION['id_pregunta'] ?>">
                    </div>
                    <div class="input-field col s2">
                    ...
                    <div class="input-field col s2">
                        <br>
                        <button name="insertar5" type="submit">Actualizar</button>
                    </div>
                    <div class="input-field col s2">
