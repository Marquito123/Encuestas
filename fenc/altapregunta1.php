    ...
    <?php 
        ...
        foreach($userLogin as $obj){ 
            ...
            if ($obj->codigo == OK ){      
                ...
                echo "</script>";
                echo '<meta http-equiv="Refresh" content="0;URL=inipre.php">';
    		...
    		<table id="table" border="1" class="striped centered" ">
    			<thead>
    				<tr>
    					...
    					<th width="10%" style="display: none;">Orden</th>
    					<th width="40%">Texto</th>
    					<th width="10%" style="display: none;">Tipo</th>
    					<th width="10%" style="display: none;">Respuestas</th>
    			...
    			<tbody>
    				<?php foreach ($array as $row): ?>
    					<tr>
    						...
    						<td height="1%" style="display: none;"><?php echo $row->preg_orden; ?></td>
    						<td height="1%"><?php echo $row->preg_texto;  ?></td>
    						<td height="1%" style="display: none;"><?php echo $row->id_tipo_preg;  ?></td>
    						<td height="1%" style="display: none;"><?php echo $row->preg_respuestas;  ?></td>
    	...
    	<div class="row">
    		<div id="activa" class="section scrollspy">
    			<form method="post" class="col s12">
                    ...
                    <div class="input-field col s2">
                        <input type="text" name="id_tipo_preg" id="resp_estatus" placeholder="Tipo" list="tipo">
                    </div>
                    <div class="input-field col s2">
                        <input type="text" name="id_usuario" placeholder="Id usuario" value="<?php echo $_SESSION['Usuario'] ?>">
                    </div>
                    <div class="input-field col s2">
                        <input type="text" name="Estatus" id="resp_estatus" placeholder="Estatus" list="estatus">
                    </div>
                    <!--<div class="input-field col s2">
                        <select name="Estatus">
                    ...
                    <div class="input-field cols s2">
                        <button name="insertar5" type="submit">Cambiar</button>
                    </div>
                </form>
    		</div>
    	</div>
